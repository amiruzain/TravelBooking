...
function smtp_mail($to, $subject, $message, $from_name, $from, $cc, $bcc, $debug=false) {
  ...
  $mail->SMTPAuth 	= true;                        				
  $mail->Host 		  = 'mail.jagadtour.com';  // Masukkan Server SMTP
  $mail->Port 		  = 25;                                      // Masukkan Port SMTP - 587
  $mail->SMTPSecure = 'tls';                                    // Masukkan Pilihan Enkripsi ( `tls` atau `ssl` )
  $mail->Username 	= 'reservasi@jagadtour.com';                // Masukkan Email yang digunakan selama proses pengiriman email via SMTP
  $mail->Password 	= 'jagad12345';        						          // Masukkan Password dari Email tsb
  $default_email_from       = 'reservasi@jagadtour.com';        // Masukkan default from pada email
  $default_email_from_name  = 'JagadTour.com';           // Masukkan default nama dari from pada email
